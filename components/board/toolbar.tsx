...
export function Toolbar() {
    ...
    return (
        <motion.div 
            drag
            dragMomentum={false}
            className="absolute top-1/2 left-4 -translate-y-1/2 flex flex-col gap-2 pointer-events-none z-[30]"
        >
            <div className="flex flex-col gap-2 bg-white dark:bg-neutral-800 p-2 rounded-lg shadow-xl border border-neutral-200 dark:border-neutral-700 pointer-events-auto items-center">
                <div className="cursor-grab active:cursor-grabbing p-1 hover:bg-neutral-100 dark:hover:bg-neutral-700 rounded transition mb-1">
                ...
                {!isCollapsed ? (
                    <>
                        ...
                        <div className="h-[1px] bg-neutral-200 dark:bg-neutral-700 my-1 w-full" />
                    ...
                    <ToolButton isActive={false} onClick={() => setIsCollapsed(false)} icon={ChevronRight} title="Développer" />
                )}

                <div className="h-[1px] bg-neutral-200 dark:bg-neutral-700 my-1 w-full" />
                <Button variant="ghost" size="icon" onClick={() => setIsCollapsed(!isCollapsed)} title={isCollapsed ? "Développer" : "Réduire"} className="h-8 w-8 text-neutral-400">
