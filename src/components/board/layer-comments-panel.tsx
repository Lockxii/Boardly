...
export function LayerCommentsPanel() {
  ...
  return (
    <div className="absolute top-22 left-4 w-72 max-h-80 flex flex-col rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white/95 dark:bg-neutral-900/95 backdrop-blur-md shadow-xl z-40 pointer-events-auto animate-in fade-in slide-in-from-left-2 duration-200">
