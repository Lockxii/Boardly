...
export const LinkMediaPreview = memo(function LinkMediaPreview({
  ...
  // A Twitter VIDEO with no captured native mp4 falls back to the Twitter embed
  // iframe on hover. Gated on mediaType so image/text tweets keep their plain
  // thumbnail (no scrollable embed on hover).
